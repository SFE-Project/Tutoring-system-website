                ...
                <div class="profile_w3layouts_details">
                    <div class="agileits_aboutme">
                        <s:iterator value="#request.listofuser" var="temp">
                            <label class="col-sm-3 control-label1" for="Relation"><s:property value="#temp.getUserType()"></s:property>：<s:property value="#temp.getNickName()"></s:property></label>
                            <div class="col-sm-9 w3_details">

                                ID：<s:property value="#temp.getUserID()"></s:property>
                            </div>
                            <p><s:property value="#temp.getRON()"></s:property> <a href="MessageShow.action?RecID=${RecID}&UserID=${RecID}&OutID=<s:property value='#temp.getUserID()'></s:property>">查看</a>
                                <a href="Jump.action?OutID=${RecID}&RecID=<s:property value='#temp.getUserID()'></s:property>">回复</a></p>
                        </s:iterator>
