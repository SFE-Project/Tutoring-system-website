    ...
    <div class="container">
        <div class="assisted_Services-agileits">
            ...
            <form action="MessageInsert.action" >
                <label></label><input type="text" hidden="hidden" name="OutID" value=${OutID}>
                <label>对方id</label><input type="text" name="RecID" value=${RecID}>
                <label></label>
                <textarea rows="10" cols="60" name="mess" required></textarea>
