...
<div class="w3ls-assisted_Services">
    <div class="container">
        <div class="assisted_Services-agileits">
            ...
            <form action="Sett.action" >
                <input type="text" name="stuEvaluationtoTea.EvaluatorID" value=${UserID}>

                <label>教师ID</label><input type="text" name="stuEvaluationtoTea.EvaluatedID">
                <label>评价内容</label>
                <textarea rows="10" cols="60" name="stuEvaluationtoTea.EvaluateContent" required></textarea>
                <label>评价星级</label>
                <input type="radio" name="stuEvaluationtoTea.Star" value="1" >1
                <input type="radio" name="stuEvaluationtoTea.Star" value="2" >2
                <input type="radio" name="stuEvaluationtoTea.Star" value="3" >3
                <input type="radio" name="stuEvaluationtoTea.Star" value="4" >4
                <input type="radio" name="stuEvaluationtoTea.Star" value="5" checkout="checked">5
                <label>评价密钥</label>
                <input type="text" name="EvaluationPassword">
                <%--学科设置--%>
